...
class GPSDataToodom:
    def __init__(self):
        ...
        self.theta = 180 #initial heading azithm nakaniwa 179.169287 tsukuba 291.09504
        self.initial_coordinate = [35.709918, 139.523032]#[latitude,longitude] nakaniwa 35.709918, 139.523032 tsukuba 36.082868166666664, 140.07699316666665
        self.latlon_info=[]
        self.count=0
    ...
    def pub(self):        
        if len(self.latlon_info) != 0:
            GPSxy = self.conversion(self.latlon_info,self.initial_coordinate,self.theta)
            #print(GPSxy)
            #print(self.latlon_info)
    ...
    def print_fix(self):
        if len(self.latlon_info) != 0:
            print(self.fix_topic.latitude)
            print(self.fix_topic.longitude)
            print(self.fix_topic.status.status)
